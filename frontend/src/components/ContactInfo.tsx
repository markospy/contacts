								...
								<div className='flex gap-2 items-center'>
									{
										contact.country &&
											<div className='flex gap-2 items-center'>
												...
												<h2 className='font-semibold'>{ clm.getCountryNameByAlpha3(contact.country) }{contact.address ? ':' : ''}</h2>
											</div>
									}
									{
										contact.address &&
							...
							}
							{
								(contact.phone && contact.phone.length > 0) &&
									<section className='flex gap-2 items-center'>
										...
										<h2 className='font-semibold'>{contact.phone.length > 1 ? 'Phones:' : 'Phone:'}</h2>
